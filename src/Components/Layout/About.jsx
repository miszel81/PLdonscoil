                  ...
                  <div className="u-maxWIdth1000 u-marginAuto u-paddingTop60 u-paddingBottom60 u-relative">
                    <div className="h-text-font h-text-backround u-rightn40 u-padding60 u-paddingBottom100 u-foreground u-width60pct u-borderBox u-marginTop8">
                      ...
                      <p className="h-text-font">
                        ...
                        offers a platform to create, manage and promote all
                        fundraising and donation activities. We will help you
                        reach the right audience and make your projects
                        successful. It’s quick and simple to use.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section className="u-relative">
                  ...
                  <div className="u-maxWIdth1000 u-marginAuto u-paddingTop60 u-paddingBottom60 u-relative">
                    <div className="h-text-font h-text-backround u-padding60 u-paddingBottom100 u-foreground u-width60pct u-borderBox u-marginTop8">
                      ...
                      <p className="h-text-font">
                        It's hard to keep students focused. Modern schools need
                        up-to-date equipment, materials and activities. It
                        doesn’t matter whether you need a computer lab,
                        educational materials or just want to organise a trip to
                        a science museum. Donscoil will let you promote your
                        project and facilitate the process of fundraising.
                      </p>
                    </div>
                  </div>
                </section>
