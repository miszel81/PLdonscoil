...
class SchoolViewSponsorProject extends Component {
  render() {
    const {
      data,
      owner,
            ...
            <div className="container project-details mt-5">
              <div className="jumbotron">
                ...
                <div className="btn-group" role="group">
                  <CustomButton
                    value={applyRenderHandler()}
                    className={"btn btn-info"}
                    onClick={() => {
                      applyHandler();
                      if (applyRenderHandler() === "Apply") {
                        this.props.props.props.history.push(
                          `/projects/apply/${data._id}`
                        );
                      }
                    }}
                  />
              ...
              {/* <p className="project-detailed-info mt-5 text-center">
                Available in:
                {data.reach.map(county => (
                  <div className="mt-3">
...
export default SchoolViewSponsorProject;
