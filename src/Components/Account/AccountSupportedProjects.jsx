...
import { getAccountSupportedProjects } from "../../services/campaignService";
import _ from "lodash";
import { Link } from "react-router-dom";
import { paginate } from "../../utils/paginate";
import Pagination from "../Common/Pagination";

class AccountSupportedProjects extends Component {
  state = {
    projects: [],
    errors: {},
  ...
  async componentDidMount() {
    const { data: projects } = await getAccountSupportedProjects(
      ...
      <div className="">
        <div className="">
          {this.state.loading ? (
            ...
            <div>
              <h1>Sorry, no projects on your list.</h1>
            </div>
          ) : (
            <div>
...
export default AccountSupportedProjects;
